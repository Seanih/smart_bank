...
function TransferHistory({ user }) {
	...
	return (
		<div className='page-container'>
			...
			<main className='flex flex-col rounded-xl justify-center items-center py-8 xs:w-[90%] sm:w-[80%] md:w-[70%] bg-gray-200 text-black'>
							...
							<tbody>
								...
								{recentTxs.map((tx, i) => (
									<tr key={i} className='odd:bg-slate-300'>
										...
										<td className='border border-black border-spacing-2 text-center px-2'>
											{tx.args[1].slice(0, 4) +
												'...' +
